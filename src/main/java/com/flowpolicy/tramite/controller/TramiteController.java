...
public class TramiteController {
  ...
  public ApiResponse<TramiteResponse> update(@PathVariable String id, @Valid @RequestBody TramiteRequest request) {
    return ApiResponse.ok("Tramite actualizado", tramiteService.update(id, request));
  }
  ...
  public ApiResponse<Void> delete(@PathVariable String id) {
    ...
    return ApiResponse.ok("Tramite eliminado", null);
  }
